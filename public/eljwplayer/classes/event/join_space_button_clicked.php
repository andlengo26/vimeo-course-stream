 ...
 * @copyright  2021 eljwplayer, Inc
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

namespace mod_eljwplayer\event;
...
class join_space_button_clicked extends \core\event\base
{
    ...
    protected function init()
    {
        ...
        $this->data['crud'] = 'r';
        $this->data['objecttable'] = 'eljwplayer';
    }
    ...
    {
        return get_string('clickjoin', 'mod_eljwplayer');
    }
    ...
    {
        return new \moodle_url('/mod/eljwplayer/view.php', array('id' => $this->other['cmid']));
    }
}
