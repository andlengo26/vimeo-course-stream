...
class JwplatformClient {
    ...
    private $_cdn_host = "cdn.jwplayer.com";
     ...
     * @return mixed
     */
    public function request_cdn($method, $path, $body = null, $headers = [], $query_params = null) {
        ...
        return $this->raw_request_cdn($method, $path, $body, $headers);
    }
    /**
     * Make an API request without modifications
     *
     ...
     * @return mixed
     */
    public function raw_request_cdn($method, $url, $body = null, $headers = []) {
        $url = 'https://' . $this->_cdn_host . $url;
...
class _PlayerClient extends _ResourceClient {
    ...
    public function embed_media($media_id, $player_id, $embed_type, $body = null, $query_params = null) {
        return $this->_client->request_cdn(
            "GET",
            "/players/" . $media_id . "-" .$player_id. "." .$embed_type,
            $body,
            [],
            $query_params
        );
...
class _PlaylistClient extends _ResourceClient {
    ...
    protected $_collection_path = "/v2/sites/{site_id}/playlists/";
